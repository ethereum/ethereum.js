...
#### web3-utils
- when fromWei returns 0, it does not add trailing decimal (#7339)
...
#### web3-eth-abi
- `decodeLog`, `decodeParametersWith`, `decodeParameters`, and `decodeParameters` now accept the first immutable param as well (#7288)
