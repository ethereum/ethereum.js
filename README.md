...
Web3.js is a TypeScript implementation of the [Ethereum JSON RPC API](https://ethereum.org/en/developers/docs/apis/json-rpc/) and related tooling maintained by [ChainSafe Systems](https://chainsafe.io).
